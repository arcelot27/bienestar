...
<head>
    ...
    <title>Home Delegados</title>
    <link rel="stylesheet" href="/assets/css/admin-css/admin_dele_home.css">
...
<body>
    <header>
        <img src="/assets/img/logo-5remov.png" alt="">
        <a href="/view/admin-view/admin_porfile.html"><i class="fa-solid fa-user-tie"></i></a>
        <a href="/view/index.html"><i class="fa-solid fa-arrow-right-from-bracket"></i></a>

    </header>
    <main>
        <div class="main_header">
            <a href="/view/admin.html"><i class="fa-solid fa-circle-chevron-left"></i></a>
        </div>
        <div class="main_body">
            <div>
